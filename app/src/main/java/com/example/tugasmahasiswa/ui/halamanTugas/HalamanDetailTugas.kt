...
import com.example.tugasmahasiswa.modelTugas.ItemDetailTugasUiState
import com.example.tugasmahasiswa.modelTugas.toTugas
...
fun DetailTugasScreen(
    ...
    viewModel: DetailTugasViewModel = viewModel(factory = PenyediaViewModelMahasiswa.Factory)
){
