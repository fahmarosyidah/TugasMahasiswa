...
import com.example.tugasmahasiswa.modelMahasiswa.HomeMahasiswaViewModel
...
fun HomeMahasiswaScreen(
    ...
    viewModel: HomeMahasiswaViewModel = viewModel(factory = PenyediaViewModelMahasiswa.Factory)
){
